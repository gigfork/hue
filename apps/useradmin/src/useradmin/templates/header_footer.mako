...
<%def name="head(title='Hue Users')">
        ...
        <head>
              ...
              body {
                ...
                <script src="/static/ext/js/jquery/plugins/jquery.jhue_contextmenu.js" type="text/javascript" charset="utf-8"></script>
                        ...
                        <div class="topbar-inner">
                                <div class="container-fluid">
                                        ...
                                        <ul class="nav">
                                                ...
                                                <li class="active"><a href="/useradmin/">User Admin</a></li>
