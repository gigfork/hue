...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('beeswax_queryhistory', 'query', self.gf('django.db.models.fields.CharField')(max_length=60000))
    ...
    models = {
        ...
        'beeswax.queryhistory': {
            ...
            'query': ('django.db.models.fields.CharField', [], {'max_length': '60000'}),
