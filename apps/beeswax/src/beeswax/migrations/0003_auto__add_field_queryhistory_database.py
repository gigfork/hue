...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QueryHistory.database'
        db.add_column('beeswax_queryhistory', 'database', self.gf('django.db.models.fields.CharField')(default='default', max_length=128), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'QueryHistory.database'
        db.delete_column('beeswax_queryhistory', 'database')
    ...
    models = {
        ...
        'beeswax.queryhistory': {
            ...
            'database': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '128'}),
