...
urlpatterns = patterns('beeswax',
  url(r'^$', 'views.index'),
  url(r'^databases$', 'views.show_databases'),
  url(r'^tables/(?P<database>\w+)$', 'views.show_tables'),
  url(r'^table/(?P<database>\w+)/(?P<table>\w+)$', 'views.describe_table'),
  url(r'^table/(?P<table>\w+)$', 'views.describe_table'),
  url(r'^table/(?P<database>\w+)/(?P<table>\w+)/partitions$', 'views.describe_partitions'),
  url(r'^table/(?P<database>\w+)/(?P<table>\w+)/load$', 'views.load_table'),
  url(r'^table/(?P<database>\w+)/(?P<table>\w+)/read$', 'views.read_table'),
  url(r'^table/(?P<database>\w+)/(?P<table>\w+)/drop$', 'views.drop_table'),
